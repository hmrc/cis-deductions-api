...
import v1.connectors.{AmendConnector, CreateConnector}
import v1.controllers.EndpointLogContext
import v1.models.errors._
import v1.models.outcomes.ResponseWrapper
import v1.models.request.{AmendRequestData, CreateRequestData}
...
class AmendService @Inject()(connector: AmendConnector) extends DesResponseMappingSupport with Logging {
  ...
  private def desErrorMap =
    Map(
      ...
      "INVALID_DEDUCTION_ID" -> DeductionIdFormatError
    )
}
