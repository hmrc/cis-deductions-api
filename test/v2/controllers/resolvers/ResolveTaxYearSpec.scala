...
import api.models.errors.{RuleDateRangeInvalidError, TaxYearFormatError}
import cats.data.Validated.{Invalid, Valid}
import support.UnitSpec
import v2.controllers.resolvers
  ...
  "ResolveTaxYear" should {
    ...
    "return an error" when {
      ...
      "passed a tax year string in which the range is greater than 1 year" in {
        ...
        result shouldBe Invalid(List(RuleDateRangeInvalidError))
      }
